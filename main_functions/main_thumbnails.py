    ...
    # NDVIdiff Use case
        ...
        try:
            ...
            color_map = {  # scaling factor 1000
                (-3000, -1000): (183, 28, 28),    # dark red
                (-999, -750): (205, 90, 72),
                (-749, -500): (228, 153, 116),
                (-499, -250): (250, 215, 160),   # light orange
                (-249, 249): (245, 245, 245),    # light grey
                (250, 499): (128, 203, 196),     # light turquoise
                (500, 749): (85, 161, 152),
                (750, 999): (43, 119, 108),
                (1000, 3000): (0, 77, 64),       # dark turquoise
            }
