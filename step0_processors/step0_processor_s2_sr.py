...
def generate_s2_sr_mosaic_for_single_date(day_to_process: str, collection: str, task_description: str) -> None:
    ...
    # SRTM - digital elevation model (slope and aspect) used for the atmospheric correction in sen2cor in a 30 m resolution
    ...
    slope_srtm = ee.Image('projects/satromo-prod/assets/res/SRTM30m_slope_radians_epsg32632')
    aspect_srtm = ee.Image('projects/satromo-prod/assets/res/SRTM30m_aspect_radians_epsg32632')
